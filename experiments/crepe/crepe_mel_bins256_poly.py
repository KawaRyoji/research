import keras
from experiments.features.mel_bins256 import construct_process
...
class CREPE_256(learning_model):
...
experimental_result_dir = "./experimental_results/crepe_mel_bins256_poly"
